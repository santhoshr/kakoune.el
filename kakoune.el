...
(defun kakoune-setup-keybinds ()
  ...
  (ryo-modal-keys
   ...
   ("b" kakoune-backward-word :first '(kakoune-set-mark-here))
   ("B" kakoune-backward-word :first '(kakoune-set-mark-if-inactive))
   ("c" kakoune-d :exit t)
   ("C" kill-line :exit t)
   ("d" kakoune-d)
   ("D" kill-line)
   ...
   ("w" kakoune-forward-word :first '(kakoune-set-mark-here))
   ("W" kakoune-forward-word :first '(kakoune-set-mark-if-inactive))
